...
const Features = () => (
  <div>
    <section id="maldini">
      ...
      <h1>General Information</h1><p className="maldini-paragraph">Maldini makes in every new collection the combination of Grace, Class, Trend and Comfort to the customer. The effort for a good job as well as for the quality of the product makes the difference.
